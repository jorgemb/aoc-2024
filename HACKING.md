...
hidden if the `aoc2024_DEVELOPER_MODE` option is disabled. Enabling this
...
You have a few options to pass `aoc2024_DEVELOPER_MODE` to the configure
...
Runs the executable target `aoc2024_exe`.
